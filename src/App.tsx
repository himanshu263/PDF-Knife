...
const tools: Tool[] = [
  { title: 'Merge PDF', desc: 'Combine multiple PDF files into one document.', icon: Layers, implemented: true, path: '/merge', category: 'Edit', color: 'text-blue-600', bg: 'bg-blue-50 dark:bg-blue-900/20' },
      ...
      <div className="w-full max-w-md glass-modal rounded-t-[2.5rem] sm:rounded-[2.5rem] shadow-2xl overflow-hidden animate-in slide-in-from-bottom-full duration-500 ease-out">
        ...
        <div className="p-6 pb-2">
          <div className="flex items-center justify-between mb-6">
             ...
             <button onClick={onClear} className="p-2 bg-gray-100 dark:bg-zinc-900 rounded-full text-gray-400 hover:text-blue-600 transition-colors"><X size={18}/></button>
          </div>
        </div>
        ...
        <div className="px-6 pb-6 space-y-4 max-h-[60vh] overflow-y-auto scrollbar-hide">
           ...
           <div>
              <button 
                ...
                className="w-full flex items-center justify-between p-4 bg-white dark:bg-zinc-900 border border-gray-100 dark:border-white/5 rounded-2xl text-[10px] font-black uppercase tracking-widest text-gray-500 hover:text-blue-600 transition-colors shadow-sm"
              >
